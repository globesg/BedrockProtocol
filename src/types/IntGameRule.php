...
final class IntGameRule extends GameRule{
	...
	public function encode(ByteBufferWriter $out, int $protocolId, bool $isStartGame) : void{
		if(($isStartGame && $protocolId < ProtocolInfo::PROTOCOL_1_26_40) || $protocolId < ProtocolInfo::PROTOCOL_1_21_111){
	...
	public static function decode(ByteBufferReader $in, int $protocolId, bool $isPlayerModifiable, bool $isStartGame) : self{
		return new self((($isStartGame && $protocolId < ProtocolInfo::PROTOCOL_1_26_40) || $protocolId < ProtocolInfo::PROTOCOL_1_21_111) ? VarInt::readUnsignedInt($in) : LE::readUnsignedInt($in), $isPlayerModifiable);
	}
}
